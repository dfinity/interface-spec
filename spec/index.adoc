 ...
 * The signature in the envelope is valid.
 * The key used to sign the request matches the public key encoded in the
   user's self-authenticating id.

More validation (e.g. authorization, key management) steps may be added here.
...
Conditions::
....
    is_self_authenticating_id E.sender_pubkey E.content.sender
...
....
   ...
   request_id_of(R) = RS.request_id_of
   S.requests[R] = RS
   is_self_authenticating_id E.sender_pubkey R.sender
   verify_signature E.sender_pubkey E.sender_sig (request_id_of(E.content)) = true
....
Read response::
A record with
...
....
  ...
  is_self_authenticating_id E.sender_pubkey Q.sender
  verify_signature E.sender_pubkey E.sender_sig (request_id_of(E.content)) = true
