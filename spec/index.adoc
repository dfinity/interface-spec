...
//If you want to learn more about the exciting inner workings of DFINITY, please consult the link:../../old/component-architecture{outfilesuffix}[Component Architecture].
