...
MethodCall = {
  ...
  callback: Callback;
  canister_history_index : CanHistoryIndex;
}
...
S = {
  ...
  canister_history: CanisterId ↦ CanHistory;
...
To convert `CallOrigin` into `CanChangeOrigin`, we define the following conversion function:
....
