...
In the second case, a page reference (a series of bytes) must be provided, which instructs the Bitcoin functionality in the replica to
...
This function returns the 100 fee percentiles, measured in Satoshi/byte, over the last 10,000 transactions, i.e.,
