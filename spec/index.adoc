...
In development instances of the Internet Computer Protocol (e.g. testnets), users with knowledge of the mapping from canisters to subnets can use their choice of the effective canister id in the URL to steer the request to a specific subnet.
====
