...
MethodCall = {
  ...
  callback: Callback;
  canister_version : CanisterStateCounter;
}
...
canister_change_origin(principal, FromCanister { canister_version = N, … }) = FromCanister {
    canister_id = principal
    canister_version = N
  }
canister_change_origin(principal, FromHeartbeat { canister_version = N, … }) = FromCanister {
    canister_id = principal
    canister_version = N
  }
....
...
S with
    ...
    call_contexts[Ctxt_id] = {
      canister = C;
      origin = FromSystem {
          canister_version = S.canister_version[C];
      };
...
S with
    ...
    canister_history[CanisterId] = {
      ...
      change_entries = H · {
          ...
          canister_version = S.canister_version[CanisterId]
          origin = FromSystem;
          change = CodeUninstall;
        };
    }
