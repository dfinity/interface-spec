...
....
    ...
    Env = { time = S.time[M.receiver]; balance = Balance_before; certificate = NoCertificate}
...
....
    ...
    Env = { time = S.time[M.receiver]; balance = S.balances[M.receiver]; certificate = NoCertificate }
...
....
  ...
  Env = { time = S.time[M.receiver]; canister_location = S.canister_location; balance = S.balances[Q.canister_id]; certificate = Cert }
....
Read response::
