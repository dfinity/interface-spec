...
If `mode = upgrade`, this will perform an upgrade of an existing canister module as described in <<system-api-upgrades>>, passing `arg` to the `post_upgrade` system method of the new instance.
