...
* ic-ref(-test): Enforce signatures checking
* ic-ref(-test): Desired canister ids must be derived from sender
* ic-ref(-test): Require the 55799 semantic CBOR tag, as specified
* ic-ref-test: Test that `ic0.msg_reply_data_append` traps after reply or reject
* ic-ref-test: Test that `ic0.msg_reject_msg_*` traps in a reply
