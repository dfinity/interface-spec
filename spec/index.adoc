...
The predicate describing the principals used for subnets is unspecified:
....
is_subnet_id : Principal -> Bool
....

These functions, predicates and constants are mutually disjoint.
