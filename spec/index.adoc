...
WARNING: In the current implementation, this also creates a canister with the given id if it does not exist; anybody can create any canister. No list of admins or controllers is maintained.

WARNING: The `mode` field is currently ignored.
