...
* `change_entries`: the list containing the most recent canister change entries. If `num_requested_change_entries` is provided, then this list contains that number of change entries or all change entries available in the system if more change entries are requested.
