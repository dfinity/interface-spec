...
* Missing: Canister states to keep (Is it observable that method calls to go the lates state, but method reads to the last finalized state? Should replies indicate from when they are.)
