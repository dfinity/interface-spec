 ...
 * Request fields that indicate public key (`sender_pubkey`) are binary blobs that contain DER-wrapped COSE encodings of the public keys, as further described below.
