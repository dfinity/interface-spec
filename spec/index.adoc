...
+
An external user can use these ids as the `sender` of a request if they own the corresponding private key.  The public key uses an encoding as described in <<authentication>>.
