...
In development instances of the Internet Computer Protocol (e.g. testnets), the effective canister id must be a canister id from the subnet's canister ranges of the subnet of the node to which the request was submitted.
====
