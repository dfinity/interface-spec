...
....
    ...
    ( E.content.canister_id = ic_principal
      ...
      S.canisters[E.content.canister_id].module.inspect_message
        (E.content.method_name, C.wasm_state, E.content.arg, E.content.sender, Env) = Return {status = Accept; cycles_used = Cycles_used;}
...
S with
    ...
    requests[M] =
      ...
      | Rejected (c, R)  if response = Reject (c, R)
....
