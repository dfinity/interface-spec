...
+
The history of the canister. The value consists of a CBOR value encoding the canister history (see <<history-cddl,CDDL description of canister history>>).
...
[#history-cddl]
=== CDDL description of canister history

The https://tools.ietf.org/html/rfc8610[Concise Data Definition Language (CDDL)] is a data description language for CBOR. The binary encoding of canister history is a CBOR value according to the following CDDL. You can also link:{attachmentsdir}/history.cddl[download the file].
