...
The canister history consists of a list of canister change entries and their total number. The system can drop the oldest canister change entries from the list to keep its length bounded, but the total number of changes records all canister changes even if the corresponding entries have already been dropped from the list, i.e., the total number of changes never decreases.
...
The list of canister change entries can be trimmed, but the total number of recorded canister changes cannot be altered.
