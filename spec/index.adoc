...
+
These ids are treated specially when an id needs to be registered. In such a request, the caller (a user or a canister) may indicate a desired id of this form, if `registering_principal` is his own id.
+
