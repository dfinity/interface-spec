...
....
    ...
    ( E.content.canister_id = ic_principal
      ...
      Arg = { data = E.content.arg; caller = E.content.sender }
      Env = {
        ...
        status = S.status[E.content.canister_id];
      }
      S.canisters[E.content.canister_id].module.inspect_message
        (E.content.method_name, C.wasm_state, Arg, Env) = Return Accept
   )
....
State after::
....
