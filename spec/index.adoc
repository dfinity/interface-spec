...
* `change_entries`: the list containing the most recent canister change entries. The list contains at most `num_requested_change_entries` canister change entries.
