...
You can interact with the DFINITY Computer using a RRPCPC interface, called the _Cloud API_, which exposes a small number of endpoints that take structured requests.
