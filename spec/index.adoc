...
hash_of_map({
  ...
  reply: {arg: <R>},
  timestamp: <t>,
  request_id: hash_of_map({request_type: "query", sender: <sender>, nonce: <nonce>, ingress_expiry: <ingress_expiry>, canister_id: <canister_id>, method_name: <method_name>, arg: <arg>})
})
....
+
