...
The system state tree might not contain paths for all canister history change entries, but at least 20 most recent change entries (or all change entries if the canister history contains less than 20 change entries) are guaranteed to be present.
