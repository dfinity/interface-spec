...
[TIP]
The canister with id `0xABCDE01` (which happens to be the little-endian 64 bit encoding of the number 1) becomes `ic:ABCDE01A7` ([online calculator](https://crccalc.com/?crc=ABCDE01&method=crc8&datatype=hex&outtype=hex)).
