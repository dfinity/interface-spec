...
The HTTP Gateway Protocol has been moved into its own https://internetcomputer.org/docs/current/references/http-gateway-protocol-spec[specification].
...
_Call context creation: Public entry points_
...
_Call context creation: Heartbeat_
...
_Call context creation: Global timer_
