...
, hex-text, leb128-cereal, mtl, parsec, prettyprinter, row-types
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    base bytestring cereal containers hex-text leb128-cereal mtl parsec
    prettyprinter row-types template-haskell text unordered-containers
    vector
  ];
  testHaskellDepends = [
