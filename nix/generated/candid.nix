...
{ mkDerivation, pkgs, base, base32, bytestring, cereal, constraints
, containers, crc, dlist, doctest, hex-text, leb128-cereal
, megaparsec, mtl, optparse-applicative, prettyprinter, row-types
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    scientific split template-haskell text unordered-containers vector
  ];
